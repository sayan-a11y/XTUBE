      ...
      <div className="min-h-full p-3 lg:p-5 xl:p-6 space-y-4">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            {/* Date range */}
            <button className="flex items-center gap-2 rounded-[20px] border border-[#1A1A1A] bg-[#0B0B0F] px-3 py-2 text-xs font-medium text-white/60 backdrop-blur-xl transition-colors hover:border-white/20 hover:text-white">
